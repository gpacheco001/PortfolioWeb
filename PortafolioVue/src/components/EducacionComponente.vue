...
const educacion = ref([
  {fecha: '2024', title: 'Tecnicatura Universitaria en Programacion', descripcion: 'Incumbencias Profesionales: Operación y programación de computadoras, desarrollo de programas en distintos lenguajes, análisis y control de sistemas informáticos.', enlace:'https://www.youtube.com/'},
  {fecha: '2023', title: 'Bootcamp .NET - Codigo Facilito', descripcion: 'Capacitación para desarrollar aplicaciones .NET completas, desde aplicaciones de consola hasta aplicaciones web utilizando ASP.NET Core.', enlace:'https://codigofacilito.com/programas/net'},
  {fecha: '2022', title: 'Argentina Programa', descripcion: 'Programa intensivo para el desarrollo de habilidades Full Stack', enlace:'http:www.direccion.com'},
